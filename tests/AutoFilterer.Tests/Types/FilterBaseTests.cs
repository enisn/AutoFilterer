...
namespace AutoFilterer.Tests.Types
{
    public class FilterBaseTests : IDisposable
    {
        ...
        public void ApplyFilterTo_WithSingleField_ShouldMatchCount()
        {
            ...
            // Act
            filterBase.ApplyFilterTo(query);
        ...
        public void BuildExpression_WithContainsString_ShouldMatchCount()
        {
            ...
            // Assert
            Assert.True(result.Count == dummyData.Count(x => x.FullName.Contains(filterBase.Email)));
        }
        ...
        [InlineData("90")]
        [InlineData("0")]
        public void BuildExpression_InnerSingleObjectWithCollectionFilter_ShouldMatchCount(string givenName)
        {
            // Arrange
